...
export type Database = {
  ...
  public: {
    Tables: {
      leads_employers: {
        Row: {
          ...
          status: Database["public"]["Enums"]["employer_lead_status"] | null
          trade: string
    ...
    Enums: {
      app_role: "admin" | "user"
      employer_lead_status: "new" | "contacted" | "quoted" | "filled" | "lost"
      worker_lead_status: "new" | "contacted" | "placed" | "inactive"
    }
    CompositeTypes: {
      [_ in never]: never
    }
