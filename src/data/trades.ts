export const TRADE_DATA = {
  labourers: {
    ...
    industries: [
      ...
      "Event setup companies",
    ],
    faqs: [
      {
        question: "What's the difference between a labourer and a trade assistant?",
        answer: "Labourers perform general construction tasks while trade assistants work directly under a tradesperson. We can supply both depending on your needs."
      },
      {
        question: "Can labourers operate machinery?",
        answer: "Some of our labourers have additional tickets for EWP, forklift or other equipment. Let us know your requirements and we'll match appropriately."
      },
      {
        question: "What's your minimum booking period?",
        answer: "We can supply labourers for as little as one day, though most clients book for multi-day or ongoing placements for project continuity."
      },
      {
        question: "How do you ensure reliability?",
        answer: "We screen all workers for attendance history and maintain a performance database. Unreliable workers don't get repeat placements, ensuring you get dependable people."
      },
    ],
  },
  demolition: {
...
export type TradeSlug = keyof typeof TRADE_DATA;
